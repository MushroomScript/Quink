        ...
        <div v-if="confirmDeleteTag" class="fixed inset-0 z-[200] flex items-center justify-center">
          ...
          <div class="relative bg-white rounded-xl shadow-xl p-5 w-72 text-center">
            ...
            <div class="flex gap-2 justify-center">
              <button @click="confirmDeleteTag = ''" class="px-4 pt-[5.75px] pb-[7.75px] text-xs rounded-lg border border-gray-200 text-gray-600 hover:bg-gray-50">取消</button>
              <button @click="doDeleteTag" class="px-4 pt-[5.75px] pb-[7.75px] text-xs rounded-lg text-white font-medium bg-red-500 hover:bg-red-600">删除</button>
            </div>
          </div>
        </div>
      </Transition>
